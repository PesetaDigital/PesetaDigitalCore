...
namespace Checkpoints
{
    ...
    // PesetaDigital: synchronized checkpoint (centrally broadcasted)
    ...
    // PesetaDigital: get last synchronized checkpoint
    ...
    // PesetaDigital: only descendant of current sync-checkpoint is allowed
    ...
    // PesetaDigital: reset synchronized checkpoint to last hardened checkpoint
...
// PesetaDigital: sync-checkpoint master key
...
// PesetaDigital: verify signature of sync-checkpoint message
...
// PesetaDigital: process synchronized checkpoint
