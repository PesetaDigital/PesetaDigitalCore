...
//higher syncronization speed if needed
static const int SKIP_VALIDATION_HEIGHT = 0;

static const int LAST_POW_BLOCK = 30000;
static const unsigned int MAX_BLOCK_SIZE = 50000000; //50MB
...
static const int64_t MAX_MONEY = 166386000 * COIN;
static const int64_t MAX_MINT_PROOF_OF_STAKE = 25 * COIN; //Max mint per block
static const int64_t COIN_YEAR_REWARD = 25 * CENT; // 25% per year (output to console will be updated)

#define FOUNDATION "PGrATiSeQwziF49h5W8oF3B9ccMjrCjR4g"
#define FOUNDATION_TEST "pesetaHiYrxhFYDuUru5bsio4ietnHiYFf"
...
static const uint256 hashGenesisBlock("0x00000035193903eef2dc98a365bd2459a29df683bd9f95844d61cb740ea197f9");
static const uint256 hashGenesisBlockTestNet("0x0000a1239f59c46c75d5416b9ba5a4d3d570bc86569a0cb9c65933a62bd6515d");
...
public:
    ...
    {
        // PesetaDigital: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of Pesetas Digitales spent by this transaction.
    ...
    /** Amount of Pesetas Digitales coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // PesetaDigital: get transaction coin age
...
public:
    ...
    // PesetaDigital: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // PesetaDigital: two types of block: proof-of-work or proof-of-stake
    ...
    // PesetaDigital: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // PesetaDigital: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // PesetaDigital: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // PesetaDigital: block index flags
    enum
    {
