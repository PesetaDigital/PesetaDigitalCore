...
// Copyright (c) 2017-2020 The PesetaDigital Developers
...
public:
    enum
    {
        PUBKEY_ADDRESS = 55, // Letra inicial // initial letter ( 55 = P )
        SCRIPT_ADDRESS = 5,
        PUBKEY_ADDRESS_TEST = 117, // Letra inicial // initial letter ( 117 = p ) - TESTNET
