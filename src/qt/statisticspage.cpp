...
void StatisticsPage::updateStatistics()
{
    ...
    ui->labelPhasePoS->setText("Only PoS = Block " + LastPoWBlock + " up");
    ui->labelPhaseHibrid->setText("Only PoS = Block " + LastPoWBlock + " up");
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " PTD" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " PTD" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " PTD");
    }
