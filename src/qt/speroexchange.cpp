...
const QString kBaseUrl = "https://main.southxchange.com/Market/Book/PTC/BTC";
const QString kBaseUrl2 = "https://main.southxchange.com/Market/Book/PTC/BTC";
const QString kBaseUrl3 = "https://main.southxchange.com/Market/Book/PTC/BTC";
QString lastp = "";
QString askp = "";
QString bidp = "";
QString highp = "";
...
{
    QDesktopServices::openUrl(QUrl("https://main.southxchange.com/Market/Book/PTC/BTC"));
}
...
void SperoExchange::parseNetworkResponse( QNetworkReply *finished )
{
    ...
    QStringList data2 = data.split("{\"MarketName\":\"BTC-PTD\",\"High\":");
