...
fName1 = "PesetaDigital-Qt"
macx:TARGET = "PesetaDigital-Qt"
VERSION = 1.0.0.0
QMAKE_TARGET_BUNDLE_PREFIX = co.PesetaDigital
...
macx: {
    ...
    ICON = src/qt/res/icons/pesetadigital.icns
    TARGET = PesetaDigital-v1.0.0.0-qt
